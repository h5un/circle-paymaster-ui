...
if (usdcBalance < 1000000) {
  console.log(
    `Smart account ${account.address} has insufficient USDC balance of ${usdcBalance}.`,
  )
  console.log(
...
console.log(
  `Smart account ${account.address} now has USDC balance of ${usdcBalance}.`,
)
...
// Next, write a frontend to let the user connect their wallet, input the amount of usdc to send and the recipient address.